...
export default function Footer() {
  return (
    <>
      <footer className="w-full bg-black pt-10">
        <div className="container mx-auto max-w-6xl px-4 py-16">
          <div className="flex flex-col gap-4 justify-center items-center">
            ...
            <h4 className="text-xs text-center font-normal text-[#FFFFFF] font-app lg:text-sm max-w-xs">
              ...
              <br />
              Phone : 0811 258 280 <br /> Email :{' '}
              <a target="_blank" href="mailto:support@nodewave.id">
                support@nodewave.id
              </a>
            </h4>
            <div className="flex items-center space-x-4">
              <a target="_blank" className="" aria-label="Facebook" href="/en">
                <svg
              ...
              <a target="_blank" className="" aria-label="Twitter" href="/en">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true"
              ...
              <a target="_blank" className="" aria-label="Youtube" href="/en">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true"
              ...
              <a target="_blank" className="" aria-label="Linkedin" href="/en">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true"
              ...
              <a target="_blank" className="" aria-label="Instagram" href="/en">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true"
