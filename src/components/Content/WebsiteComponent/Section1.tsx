          ...
          <div className="container mx-auto max-w-6xl px-4 py-8 md:py-16">
            <div className="mb-4 md:mb-8">
              <h1 className="mb-2 text-2xl font-medium text-[#FFFFFF] font-app text-center md:mb-4 lg:text-4xl">
                Professional Mobile Apps Development Services
              </h1>
              <p className="text-sm font-normal text-[#FFFFFF] text-center lg:text-base">
                Both Android and iPhone Mobile Apps, Create an Application with
                Your Preferred Features. Can be used for buying and selling
                transactions, cashier applications, informational applications,
                or chat applications with GPS features.
              </p>
            </div>
